    ...
    try {
      ...
      const requests = selectedProcesses.map(process => {
        const payload = {
          ...
          competencia: ((['websigetpublic', 'webiepublic', 'webtaesa', 'light', 'glorian', 'cpfl', 'rialmas', 'rialmav', 'rialmaiv', 'aete', 'transnorte', 'equatorial', 'copel', 'mge', 'stategrid', 'stn', 'tecp', 'elte', 'etes', 'tme', 'etem', 'etvg', 'tne', 'etc', 'etap', 'tcc', 'tpe', 'tsm', 'etb', 'amazonia', 'tcpe', 'vsb', 'verene', 'grupo_argo', 'ons', 'harpix', 'lnt', 'sigetplusv2'].includes(selectedRobotId)) && window.tempCompetencia) ? window.tempCompetencia : null,
      ...
      <main className="main-content">
        ...
        {activeTab === 'robot' && currentRobot && (
          <div className="robot-view">
            ...
            {['websigetpublic', 'webiepublic', 'webtaesa', 'light', 'glorian', 'cpfl', 'rialmas', 'rialmav', 'rialmaiv', 'aete', 'transnorte', 'equatorial', 'copel', 'mge', 'stategrid', 'stn', 'tecp', 'elte', 'etes', 'tme', 'etem', 'etvg', 'tne', 'etc', 'etap', 'tcc', 'tpe', 'tsm', 'etb', 'amazonia', 'tcpe', 'vsb', 'verene', 'grupo_argo', 'ons', 'harpix', 'lnt', 'sigetplusv2'].includes(selectedRobotId) && (
