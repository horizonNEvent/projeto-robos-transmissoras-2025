...
class EteneBot:
    def __init__(self, user_code):
        ...
        self.base_url = "https://www.etene.com.br"
    ...
    def login(self):
        ...
        Logic based on analysis of https://www.etene.com.br/ js/main.js and index HTML.
        """
        ...
        print(f"Logging in to Etene with user code: {self.user_code}...")
    ...
    def run(self, output_dir="downloads_etene", target_date=None):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Etene Transmissora Bot")
